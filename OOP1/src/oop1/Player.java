...
// Класс проигрывателя
public class Player implements InfCarr{
    ...
    // Подходит ли данному устройству этот накопитель
    public boolean InfCarr(String Carrier){
        return this.name.equals(Carrier);
    }
    ...
    public void play(){
        ...
        } else if (!InfCarr(this.pl_carr.carr)){
